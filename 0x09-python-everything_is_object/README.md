...
This project explains my learning of object instantiation in Python and other terms like; variable aliasing and object identifiers, types, and mutability. Instead of programs, this project contains a series of quiz-like questions with the answers provided in single-line text files.

## Resources
* [Object and Values](http://www.openbookproject.net/thinkcs/python/english2e/ch09.html#objects-and-values)
* [Aliasing](http://www.openbookproject.net/thinkcs/python/english2e/ch09.html#aliasing)
* [Immutable vs Mutable types](https://stackoverflow.com/questions/8056130/immutable-vs-mutable-types)
* [Mutation in Python](http://composingprograms.com/pages/24-mutable-data.html#sequence-objects)
...
* [test](./test): Test folder for the project
